...
a = Analysis(
    ...
    hiddenimports=['i18n_manager', 'manual_cli', 'mcp_server', 'license_engine', 'updater_engine', 'mobile_link_server', 'markitdown', 'markdownify', 'magika', 'beautifulsoup4', 'soupsieve', 'docx', 'lxml'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[
